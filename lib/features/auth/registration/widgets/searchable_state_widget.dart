...
class SearchableStateWidget extends StatefulWidget {
  ...
  @override
  State<SearchableStateWidget> createState() => _SearchableStateWidgetState();
}

class _SearchableStateWidgetState extends State<SearchableStateWidget> {
  ...
  Future<void> getAuthOptions() async {
    ...
    setState(() {
      ...
      filteredItems = (authDropdownOptions.data?.states ?? [])
